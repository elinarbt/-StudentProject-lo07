...
<div class="container">
        ...
        <div class="panel panel-body">
            <ul>
                <li><h4>Problèmes récurrents de chemins de répertoire.
                    ...
                    Cela n'est dû qu'au simple fait de comprendre comment l'organisation du projet est formé, et de voir quels fichiers aller chercher au bon endroit.
                    <br>
    ...
    <div class="panel panel-danger">
        ...
        <div class="panel-body">
            <h4>Dans ce projet précisément, le code est parfois répétitif dans sa mise en forme. <br>
